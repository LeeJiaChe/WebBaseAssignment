...
$_title = 'Fujifilm Products - VisionX';
...
// Query Fujifilm products from database
$stmt = $db->prepare("SELECT id, name, price, image_path, description, category_id FROM products WHERE name LIKE 'Fujifilm%'");
...
<div class="brand-header">
    ...
    <p>Discover premium Fujifilm cameras and lenses</p>
...
function sortProducts() {
    ...
    // After sorting, re-append the cards to the grid to update the display order
...
// Initial filtering/sorting (important for products loaded via PHP)
