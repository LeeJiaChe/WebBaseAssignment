...
// Action cameras classified by image/name containing actioncam/insta360
$stmt = $db->prepare("SELECT id, name, price, currency, image_path, description FROM products WHERE image_path LIKE '%actioncam%' OR name LIKE 'Insta360%' OR name LIKE '%Action%' ORDER BY name ASC");
$stmt->execute();
$rows = $stmt->fetchAll();
...
<div class="category-header">
    ...
    <p>Capture your adventures with our action cameras</p>
</div>
