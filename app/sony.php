...
$imagesDir = __DIR__ . '/images/sony_product';

$files = is_dir($imagesDir) ? array_values(array_filter(scandir($imagesDir), function ($f) {return !in_array($f, ['.','..']);})) : [];

$priceRanges = [3999,2499,2999,1999,3499];

$categories = ['Mirrorless', 'Compact', 'Mirrorless', 'Compact', 'Mirrorless'];
...
<div class="brand-header">
    ...
    <p>Discover premium Sony cameras and lenses</p>
