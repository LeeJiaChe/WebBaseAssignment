<?php
require '_base.php';
$_title = 'Camera Accessories - VisionX';
...
// Accessories classified by image/name containing accessories
$kw = '%accessor%';
$stmt = $db->prepare("SELECT id, name, price, currency, image_path, description FROM products WHERE image_path LIKE :kw1 OR name LIKE :kw2 ORDER BY name ASC");
...
<div class="category-header">
    ...
    <p>Essential accessories for your camera gear</p>
</div>
